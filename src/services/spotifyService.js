...
export const getLoginUrl = async () => {
    if (!CLIENT_ID) {
        console.error("Configuration Error: VITE_SPOTIFY_CLIENT_ID is missing.");
        alert("Configuration Error: VITE_SPOTIFY_CLIENT_ID is missing. Please check your GitHub Secrets.");
        return "#";
    }
